...
describe CouponTypesController do
  ...
  def mock_coupon_type(stubs={})
    @mock_coupon_type ||= mock_model(CouponType, stubs).as_null_object
  end

  describe "GET index" do
    it "assigns all coupon_types as @coupon_types" do
      CouponType.stub(:all) { [mock_coupon_type] }
      get :index
      assigns(:coupon_types).should eq([mock_coupon_type])
    end
  end

  describe "GET show" do
    it "assigns the requested coupon_type as @coupon_type" do
      CouponType.stub(:find).with("37") { mock_coupon_type }
      get :show, :id => "37"
      assigns(:coupon_type).should be(mock_coupon_type)
    end
  end

  describe "GET new" do
    it "assigns a new coupon_type as @coupon_type" do
      CouponType.stub(:new) { mock_coupon_type }
      get :new
      assigns(:coupon_type).should be(mock_coupon_type)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "assigns a newly created coupon_type as @coupon_type" do
        CouponType.stub(:new).with({'these' => 'params'}) { mock_coupon_type(:save => true) }
        post :create, :coupon_type => {'these' => 'params'}
        assigns(:coupon_type).should be(mock_coupon_type)
      end

      it "redirects to the created coupon_type" do
        CouponType.stub(:new) { mock_coupon_type(:save => true) }
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved coupon_type as @coupon_type" do
        CouponType.stub(:new).with({'these' => 'params'}) { mock_coupon_type(:save => false) }
        post :create, :coupon_type => {'these' => 'params'}
        assigns(:coupon_type).should be(mock_coupon_type)
      end

      it "re-renders the 'new' template" do
        CouponType.stub(:new) { mock_coupon_type(:save => false) }
        post :create, :coupon_type => {}
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "assigns the requested coupon_type as @coupon_type" do
        CouponType.stub(:find) { mock_coupon_type(:update_attributes => true) }
        put :update, :id => "1"
        assigns(:coupon_type).should be(mock_coupon_type)
      end
    ...
    describe "with invalid params" do
      it "assigns the coupon_type as @coupon_type" do
        CouponType.stub(:find) { mock_coupon_type(:update_attributes => false) }
        put :update, :id => "1"
        assigns(:coupon_type).should be(mock_coupon_type)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the coupon_types list" do
      CouponType.stub(:find) { mock_coupon_type }
      delete :destroy, :id => "1"
